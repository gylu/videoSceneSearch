...
#rdd.flatMap(getFrames).saveAsTextFile("hdfs://ec2-52-41-224-1.us-west-2.compute.amazonaws.com:9000/output15.txt")
rdd.flatMap(getFrames).saveToCassandra("vss","hval") #still not working
...
/home/ubuntu/playground/getFramesHash_sparkJob.py
